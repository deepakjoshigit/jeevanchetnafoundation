...
const TreeDonation = () => {
  return (
    <>
      <SEO
        title="Tree Donation | Plant a Tree, Grow a Future with Jeevan Chetna Foundation"
        description="Support Jeevan Chetna Foundation's environmental sustainability efforts by donating to plant trees. Combat climate change and contribute to a greener planet."
      />
